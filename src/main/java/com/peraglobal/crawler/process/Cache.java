...
/**
 * A cache that allows a entity's data to persist locally prior being joined to
 * other data and/or indexed.
 * 
 */
public interface Cache extends Iterable<Map<String, Object>> {
	...
	/**
	 * <p>
	 * Returns an iterator, allowing callers to iterate through all documents
	 * that match the given key in insertion order.
	 * </p>
	 */
